...
<YYINITIAL>{NUMBER}{return new Token.NUMBER, yytext());}
...
<YYINITIAL>{NEGGA}{return new Token(Token.UNARY);}
<YYINITIAL>{LPAR}{return new Token(Token.LPAREN);}
<YYINITIAL>{RPAR}{return new Token(Token.LPAREN);}
